 ...
 */
class getActeurRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActeurRepository.php';

        return $container->privates['App\\Repository\\ActeurRepository'] = new \App\Repository\ActeurRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
