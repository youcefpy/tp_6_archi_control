 ...
 */
class getActeurFilmRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActeurFilmRepository' shared autowired service.
     *
     * @return \App\Repository\ActeurFilmRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActeurFilmRepository.php';

        return $container->privates['App\\Repository\\ActeurFilmRepository'] = new \App\Repository\ActeurFilmRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
