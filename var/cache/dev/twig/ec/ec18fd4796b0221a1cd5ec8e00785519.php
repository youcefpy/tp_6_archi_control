...
class __TwigTemplate_d2e4e86d63b541f16dba067e6806c648 extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 32
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 32, $this->source); })()), "roleListeFilmPrefere", [], "any", false, false, false, 32), "html", null, true);
        yield "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "utilisateur/show.html.twig", "C:\\symfony_tuto\\tp_6_archi_control\\templates\\utilisateur\\show.html.twig");
    }
}
